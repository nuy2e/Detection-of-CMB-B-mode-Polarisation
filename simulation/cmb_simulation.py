...
def get_dust_emission(patch_center, patch_size=10.0, xsize=256, freq_ghz=150):
    """
...
if __name__ == "__main__":
    ...
    Q_dust, U_dust, Cl_dust, elld = get_dust_emission(patch_center, patch_size=patch_size, xsize=N_pixels, freq_ghz=150)
